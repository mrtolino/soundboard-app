...
<html>
  ...
  <body>
    ...
    <p>
      ...
      <form id= 'changePage' action= 'listPubBoard.php' method='get'>
...
if($page == 'all') {
  ...
  echo "<form id= 'pageChange' action= 'listPubBoard.php' method = 'get'>
          <input type= 'hidden' name= 'title' value= \"$title\">
...
if ($result) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $soundFileName1 = $row['u_sound_filename'];

    $imgFileName = "./uploads/".$imgFileName;
    $soundFileName = "./uploads/".$soundFileName1;

    echo "<div class='sBoardDiv' title=$soundFileName1
    ...
    <script type='text/javascript'>
      window.onload = function() {
        ...
        changeView.addEventListener('click', function() {
          ...
          window.location = \"publicboard.php?title=$title&page=all&pageNumber=1\";
        });
