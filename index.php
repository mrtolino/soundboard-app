  ...
  <body>
    ...
    <div id="content">
      ...
      <p>
        ...
        <form id= 'changePage' action= 'index.php' method='get'>
        ...
        /*if($page == 'all') {
          ...
          echo "<form id= 'pageChange' action= 'index.php' method = 'get'>
        ...
        $sql = "select * from Boards where public='1'";
        $result = mysqli_query($link, $sql);
    ...
    window.onload = function() {
      ...
      /*changeView.addEventListener('click', function() {
        window.location = 'listIndex.php?page=all&pageNumber=1';
      });
