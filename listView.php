  ...
  <body>
    ...
    <div id="content">
      ...
      <p>
        ...
        <form id= 'changePage' action= 'listView.php' method='get'>
          <select id= 'choosePage' name= 'numPage'>
        ...
        if($page == 'all') {
          ...
          echo "<form id= 'pageChange' action= 'listView.php' method = 'get'>
                  <input type = 'hidden' name= 'numPage' value = $page>
                  <input id = 'pageNumber' type= 'hidden' name= 'pageNum'>";
          if($lowerBound == 0) {
        ...
        if ($result) {
          while($row=mysqli_fetch_assoc($result)) {
            $title = $row['title'];
            echo "<div class='sBoardDiv' style = 'display: block'>
