<?php
  ...
  <html>
    ...
    <body>
      ...
      <p>
        ...
        <form id= 'changePage' action= 'listMyBoards.php' method='get'>
  ...
  if($page == 'all') {
    ...
    echo "<form id= 'pageChange' action= 'listMyBoards.php' method = 'get'>
      ...
      <script type='text/javascript'>
        window.onload = function() {
          ...
          changeView.addEventListener('click', function() {
            window.location = 'myboards.php?page=all&pageNumber=1';
          });
